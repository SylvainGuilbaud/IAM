This is a readme file for InterSystems API Manager (IAM) version 3.10.0.2-ubuntu.
...
*) In case you are moving to 2.8.4.11-alpine from a different version, make sure to backup your database before you begin.
...
4) In case you are upgrading to 2.8.4.11-alpine from an another version and your database is postgres:9.6 or postgres:14.5, you will have to follow the steps mentioned in one of the README files in the database upgrade folders in under /scripts file. If your old database is postgres:17.4, you don't need to upgrade the database to use this version of IAM.
...
Copyright © 2025 InterSystems Corporation, Cambridge, MA